...
/**
 * Generated class for the PersonalOnePage page.
 *
...
@Component({
  selector: 'page-personal-one',
  templateUrl: 'personal-one.html',
})
export class PersonalOnePage {
  form: FormGroup;
  maxDate: any;
  minDate: any;
  ...
  ionViewDidLoad() {
    ...
    this.http.post("http://www.qjskills.com/May29Services/Select.php", { requestType: "get person one info", userNumber: 'help to select userID' }, {})
    .then(data => {
  ...
  onSubmit(){
    ...
    spinner.present();
    let body = {
      requestType: "update person one info",
